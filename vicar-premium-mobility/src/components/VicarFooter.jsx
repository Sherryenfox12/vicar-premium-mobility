        ...
        <div className="vicar-footerLux__top">
          <div className="vicar-footerLux__brand">
            ...
            <div className="vicar-footerLux__social" aria-label="Social links">
              <a href="https://www.facebook.com/share/1B6HdbnitA/" target="_blank" rel="noopener noreferrer" className="vicar-footerLux__socialBtn" aria-label="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/vicar.malaysia?igsh=MWZsa2ZlZ3prMWpodg==" target="_blank" rel="noopener noreferrer" className="vicar-footerLux__socialBtn" aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://api.whatsapp.com/send/?phone=601155532999&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="vicar-footerLux__socialBtn" aria-label="WhatsApp">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="vicar-footerLux__cols">
            ...
            <div className="vicar-footerLux__col">
              ...
              <div className="vicar-footerLux__meta">
                ...
                <a className="vicar-footerLux__metaValue" href="mailto:enquiry@vicar.com.my">enquiry@vicar.com.my</a>
              </div>
              <div className="vicar-footerLux__meta">
                <span className="vicar-footerLux__metaLabel">Phone</span>
                <a className="vicar-footerLux__metaValue" href="tel:+601155532999">011-55532999</a>
              </div>
              <div className="vicar-footerLux__meta">
